...
#ggsave("~/unhcr_r_project/displacement/out/map/map-toner.png", toner, width=8, height=6,units="in", dpi=300)
...
#osmm <- ggmap(osm)
#ggsave("~/unhcr_r_project/displacement/out/map/map-osm.png", osmm, width=8, height=6,units="in", dpi=300)
...
#ggsave("~/unhcr_r_project/displacement/out/map/map-googleterrain.png", googleeterrain, width=8, height=6,units="in", dpi=300)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-overlay.png", overlay, width=8, height=6,units="in", dpi=300)
...
#ggsave("~/unhcr_r_project/displacement/out/map/map-density2.png", density2, width=8, height=6,units="in", dpi=300)
...
density <-ggmap(googleterrain)+
          ...
          ggtitle("IDPs in Iraq")+theme(plot.title=element_text(size=20))
ggsave("~/unhcr_r_project/displacement/out/map/map-density.png", density, width=8, height=6,units="in", dpi=300)
#############################################################
#############################################################
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityOpenair.png", densityOpenair, width=8, height=6,units="in", dpi=300)
rm(master.Openair)
rm(densityOpenair)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityschool.png", densityschool, width=8, height=6,units="in", dpi=300)
rm(master.school)
rm(densityschool)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityImprovised.png", densityImprovised, width=8, height=6,units="in", dpi=300)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityOrganised.png", densityOrganised, width=8, height=6,units="in", dpi=300)
rm(master.Organised)
rm(densityOrganised)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityRented.png", densityRented, width=8, height=6,units="in", dpi=300)
rm(master.Rented)
rm(densityRented)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityHosted.png", densityHosted, width=8, height=6,units="in", dpi=300)
rm(master.Hosted)
rm(densityHosted)
...
ggsave("~/unhcr_r_project/displacement/out/map/map-densityerbil.png", densityerbil, width=8, height=6,units="in", dpi=300)

#raster1 <- ggmap(googleterrain) + geom_point(aes(x = Longitude, y = Latitude), data = master,alpha = 4/10, colour = 'red', size = 2)
# Save this!
#ggsave("~/unhcr_r_project/displacement/out/map/map-raster1.png", raster1, width=8, height=6,units="in", dpi=300)

#raster <- ggmap(iraqstamentoner) + geom_point(aes(x = Longitude, y = Latitude), data = master,alpha = 4/10, colour = 'red', size = 2)
# Save this!
#ggsave("~/unhcr_r_project/displacement/out/map/map-raster.png", raster, width=8, height=6,units="in", dpi=300)
...
#mapcommunal
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-pc-communal-setting.png", mapcommunal, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
rm(mastermapcamp)
...
mapcamp <- mapcamp + 
  ...
  theme_bw()
ggsave("~/unhcr_r_project/displacement/out/map/map-camp-setting.png", mapcamp, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-communal-month-origin.png", mapcommunalmonthorigin, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mapmonthorigin <- mapmonthorigin + geom_point(aes(x=Longitude,  y=Latitude, size=total), data=master, color="coral1")+
  ...
  theme_bw()
ggsave("~/unhcr_r_project/displacement/out/map/map-month-origin.png", mapmonthorigin, width=10, height=9,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-total-communal-hex.png", maptcommunalhex, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-pc-communal-hex.png", mapcommunalhex, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-pc-communal-hex-origin.png", mapcommunalhexorigin, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
maptcamphex
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-total-camp-hex.png", maptcamphex, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mapcamphex
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-pc-camp-hex.png", mapcamphex, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
#mapcommunalhexmonth
# Save this!
#ggsave("~/unhcr_r_project/displacement/out/map/map-pc-communal-hex-month.png", mapcommunalhexmonth, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-communal-hex-month-origin.png", mapcommunalhexmonthorigin, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mappriorityfood
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-food.png", mappriorityfood, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mappriorityshelter
 # Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-shelter.png", mappriorityshelter, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mapprioritynfi
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-nfi.png", mapprioritynfi, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mapprioritywater
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-water.png", mapprioritywater, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mapprioritycash  <- mapprioritycash+
 ...
 mapprioritycash
# Save this!
 ggsave("~/unhcr_r_project/displacement/out/map/map-priority-cash.png", mapprioritycash, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
mappriorityhealth
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-health.png", mappriorityhealth, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/map/map-priority-child.png", mapprioritychild, width=8, height=6,units="in", dpi=300)
#########################################################################
#########################################################################

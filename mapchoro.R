...
#irq_adm1 <- readOGR(dsn = "~/unhcr_r_project/displacement/shp/irq_admbnda_adm1_ocha_20140717", "irq_admbnda_adm1_ocha_20140717")
irq_adm1 <- readShapePoly('~/unhcr_r_project/displacement/shp/irq_admbnda_adm1_ocha_20140717.shp', proj4string=CRS("+proj=longlat"))
#
#plot(irq_adm1)
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1.png", maplevel1, width=8, height=6,units="in", dpi=300)
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_idppop.png", maplevel1_idppop, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_classschool.png", maplevel1_classschool, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_commprivaterank.png", maplevel1_commprivaterank, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_commsettingrank.png", maplevel1_commsettingrank, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_totalrank.png", maplevel1_totalrank, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_composite.png", maplevel1_composite, width=8, height=6,units="in", dpi=300)
######################################################################
...
ggsave("~/unhcr_r_project/displacement/out/mapchoro/maplevel1_idpref.png", maplevel1_idpref, width=8, height=6,units="in", dpi=300)

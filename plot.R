...
# Save this!
ggsave("~/unhcr_r_project/displacement/test.png", plotmonth1, width=8, height=6,units="in", dpi=300)
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/plot/plot-month.png", plotmonth, width=8, height=2,units="in", dpi=300)
ggsave("~/unhcr_r_project/displacement/out/plot/plot-month.svg", plotmonth, width=8, height=2,units="in", dpi=300)
...
plotstatus <- ggplot(data=master.status, aes(x=Displacement.Info.Status , y=total))+
  ...
  theme(plot.title=element_text(face="bold", size=14),
        ...
        axis.text.x=element_text(face="italic", size=7),
        axis.text.y=element_text(face="bold", size=7))
ggsave("~/unhcr_r_project/displacement/out/plot/plot-status.png", plotstatus, width=8, height=6,units="in", dpi=300)
rm(master.status)
rm(plotstatus)
...
# Save this!
ggsave("~/unhcr_r_project/displacement/out/plot/plot-accomodation-main-gov.png", plotaccomodationgovm, width=8, height=6,units="in", dpi=300)
ggsave("~/unhcr_r_project/displacement/out/plot/plot-accomodation-main-gov.svg", plotaccomodationgovm, width=8, height=6,units="in", dpi=300)
...
ggsave("~/unhcr_r_project/displacement/out/plot/plot-month1.png", plotmonth1, width=8, height=6,units="in", dpi=300)
